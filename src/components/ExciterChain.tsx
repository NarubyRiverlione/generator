...
export function ExciterChain({ iFieldPu }: Props) {
  ...
  return (
    <>
      <Gauge value={acV} min={0} max={150} unit="V" label="EXCITER OUTPUT" subLabel="0 – 150 V AC" zones={EXCITER_ZONES} />
      <Gauge value={dcV} min={0} max={150} unit="V=" label="RECTIFIED OUTPUT" subLabel="0 – 150 V DC" zones={EXCITER_ZONES} />
